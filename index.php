...
<head>
    ...
    <title>ขายมือถือ - คณะมนุษยศาสตร์และสังคมศาสตร์ มหาวิทยาลัยราชภัฏนครปฐม</title>
    <!-- Favicon-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning">
        <div class="container-fluid px-4 px-lg-5">
            <a class="navbar-brand"><i class="fas fa-atom"></i> WOJA</a>
    ...
    <header class="bg-or-5 py-1 bg-header-img">
        <div class="container-fluid px-4 px-lg-5 my-5">
            <div class="text-center orange-theme-4">
                <h1 class="display-4 fw-bolder">ขายมือถือ</h1>
                <p class="lead fw-normal text-50 mb-0">สเปคมือถือ</p>
            </div>
        </div>
    </header>
    <!-- Section-->
    ...
    <footer class="py-5 bg-green">
        <div class="container-fluid">
            <p class="m-0 text-center text-dark">
                บริษัท วรปกร จารุศิริพจน์ จํากัด มหาชน
                <br>
